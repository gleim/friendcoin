...
@property (nonatomic) CALayer *styleLayer;
...
@property (nonatomic) KGModalGradientView *styleView;
@end

@interface KGModal()
@property (nonatomic) UIWindow *window;
@property (nonatomic) UIViewController *contentViewController;
@property (nonatomic) KGModalViewController *viewController;
@property (nonatomic) KGModalContainerView *containerView;
@property (nonatomic) KGModalCloseButton *closeButton;
